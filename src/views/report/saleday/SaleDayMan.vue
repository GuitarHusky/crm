<template>
  <div class="purchase_order">
    ...
    <Row>
      ...
      <Button type="primary" @click="getDayBizuserReports">查询</Button>
      </Col>
    </Row>
...
<script>
 import { getDayBizuserReport,searchDayBizuserReport } from '../../../api/api'
  export default {
    data() {
      return {
        options: {
