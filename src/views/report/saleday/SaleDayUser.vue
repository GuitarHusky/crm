<template>
  <div class="purchase_order">
    ...
    <Row>
      ...
      <Button type="primary" @click="getDayUsersReports">查询</Button>
      </Col>
    </Row>
...
<script>
 import { getDayUsersReport,searchDayUserReport } from '../../../api/api'
  export default {
    data() {
      return {
        options: {
    ...
    methods:{
      changepage1(index){
        ...
        getDayUsersReport({
          ...
          this.dayreportcountdata[0]['profit'] = this.profit
          this.dayreportcountdata[0]['rate'] = this.rate
        })
        })
      },
      changepage2(){
