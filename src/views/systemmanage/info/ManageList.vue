			...
			<div style="line-height: 32px;">
				<Row style='margin-bottom: 10px;'>
					...
					<Row>
						...
						<Col span="18">
						<Input v-model="user.login_name"></Input>
						</Col>
					</Row>
					</Col>
				...
				<Row style='margin-bottom: 10px;'>
					...
					<Row>
						...
						<Col span="18">
						<DatePicker style='width: 100%;' type="date" v-model='user.birthday' placement="bottom-end" placeholder="请选择出生日期" :editable="empstatus"></DatePicker>
						</Col>
					</Row>
					</Col>
					<Col span="12" style="text-align:center;">
					<Row>
						...
						<Col span="18">
						<Input v-model="user.id_card_number"></Input>
						</Col>
					</Row>
					</Col>
				</Row>
				<Row style='margin: 10px 0;'>
					<Col span="3" style="text-align:center;">电子邮箱</Col>
					<Col span="21">
				...
				<Row style='margin-top: 10px;'>
					...
					<Row>
						...
						<Select v-model="user.gender" style="width:100%">
					...
					<Row>
						...
						<Col span="18">
						<!--<RadioGroup v-model="user.enabled" @on-change='addStatusChange(user.enabled)'>
							<Radio label="1">
								<span>允许登录</span>
							</Radio>
							<Radio label="0">
						...
						<Select v-model="user.enabled" style="width:100%">
